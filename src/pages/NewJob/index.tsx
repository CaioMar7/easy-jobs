            ...
            <NewJobForm>
                ...
                <JobFields>
                    ...
                    <label htmlFor="description">
                        Descrição
                        <input type="text" placeholder="ex: Utilizará ferramentas XYZ para..." name="description" id="description"></input>
                    </label>

                    <label htmlFor="required">
                        Requisitos
                        <input type="text" placeholder="ex: Ensino superior completo, excel avançado..." name="required" id="required"></input>
                    </label>
                </JobFields>
